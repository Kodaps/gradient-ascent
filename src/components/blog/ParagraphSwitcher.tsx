...
export const ParagraphSwitcher:React.FC<ParagraphProps> = ({paragraph, lang}) => {
  ...
  if (isTwitterEmbed(paragraph)) {
    ...
    return <div className="w-full not-prose flex flex-row justify-center">
        <Tweet id={embedId} />
      </div>;
  }

  return <div dangerouslySetInnerHTML={{__html: renderMarkdown(paragraph, true)}} />;
}
