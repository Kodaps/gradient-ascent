...
import { FAQCollapseProps } from '@/shared/types';

const Collapse = ({ items, classCollapseItem, iconUp, iconDown }: FAQCollapseProps) => {
        ...
        >
          <div className={classCollapseItem}>
            <div
              ...
              role="button"
            >
              <h2 className="w-full pr-2 text-lg font-medium leading-6 text-gray-900 dark:text-slate-300">{question}</h2>
